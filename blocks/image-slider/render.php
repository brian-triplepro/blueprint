...
$arrow_color = $colors['arrow_color'] ?? 'text-dark';
...
<section class="<?= esc_attr( $section_classes ); ?>" style="--slider-arrow-color: var(--color-<?php echo esc_attr( $arrow_color ); ?>);">
  <div class="container">
    <?php if ( ! empty( $images ) ) : ?>
